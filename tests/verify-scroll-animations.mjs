...
const checks = [
  ...
  ["Equipment section lists specific Atlas equipment", html.includes("Rogue Fitness rig") && html.includes("Maintained Olympic bars") && html.includes("standard strength bars") && html.includes("Rogue and American plates") && html.includes("pounds and kilos") && html.includes("GHD machine") && html.includes("single cable machine") && html.includes("Bands, dumbbells, and kettlebells")],
  ...
  ["Methodology uses concise Atlas position", html.includes("Three lenses. One Atlas bias.") && html.includes("Chinese-influenced technique, adapted to the athlete.") && html.includes("Mobility before load.") && html.includes("Drills with a reason.") && !html.includes("We use the Chinese method.") && !html.includes("raw intensity")],
